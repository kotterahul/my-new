...
solar_energy_production = [random.randint(1, 1000) for _ in range(24)]
...
while step < 24:
  ...
  w3.eth.default_account = "0xDbC833D446dbd613Ec6B2c7ee73e8ca1818D18A4"
  ...
  address = Web3.to_checksum_address("0x122Ada217c22C79228B2EE7f28a770F655B9a761")
